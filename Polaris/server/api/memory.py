...
async def list_memories(
    ...
    """获取记忆列表"""
    try:
        from memory.long_term_memory import get_recent_memories
...
async def search_memories(request: MemorySearchRequest):
    """语义搜索记忆"""
    try:
        from memory.long_term_memory import search_memories_by_vector
...
async def delete_memory(memory_id: int):
    """删除一条记忆"""
    try:
        from memory.long_term_memory import delete_memory
